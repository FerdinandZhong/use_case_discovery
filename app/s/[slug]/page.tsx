    ...
    return (
      <main className="min-h-screen grid place-items-center px-6">
        <div className="max-w-md text-center">
          ...
          <h1 className="mt-4 text-2xl font-semibold">Survey not found</h1>
          <p className="mt-2 text-cloudera-slate">
            This link doesn’t match an active survey. Please double-check the URL with your
            Cloudera contact.
          </p>
        </div>
      </main>
  ...
  if (survey.status === 'closed') {
    return (
      <main className="min-h-screen grid place-items-center px-6">
        <div className="max-w-md text-center">
          <div className="text-cloudera-orange font-bold tracking-widest text-sm">CLOUDERA</div>
          <h1 className="mt-4 text-2xl font-semibold">This survey is closed</h1>
